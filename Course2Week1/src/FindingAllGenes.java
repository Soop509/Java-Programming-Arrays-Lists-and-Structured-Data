...
public class FindingAllGenes {
	public void printOut(StorageResource resource) {
    	int count = 0;
    	...
    	System.out.println(count+" item(s) counted");
    }
	public void test() {
		FileResource f = new FileResource();
		String string = f.asString();
		StorageResource s = findProtein(string);
		printOut(s);
		
	}

    public static void main(String[] args) {
    	String path = "/home/masupha/eclipse-workspace/Datasets/Genes/GRch38dnapart.fa";
